    ...
    8162: function (r, e, t) {
      ...
      function o(r) {
        ...
        for (var o = 0; o < r.length; o++) {
          var a = r.charAt(o),
            f = a.charCodeAt(0);
          if (255 !== e[f]) throw new TypeError(a + " is ambiguous");
          e[f] = o;
        }
        var i = r.length,
          u = r.charAt(0),
          l = Math.log(i) / Math.log(256),
          c = Math.log(256) / Math.log(i);
        function h(e) {
          if (
          ...
          var y = l - o;
          while (y !== l && 0 === h[y]) y++;
          for (var v = u.repeat(t); y < l; ++y) v += r.charAt(h[y]);
          return v;
        }
        function w(r) {
          if ("string" !== typeof r) throw new TypeError("Expected String");
          if (0 === r.length) return n.alloc(0);
          var t = 0,
            o = 0,
            a = 0;
          while (r[t] === u) o++, t++;
          var f = ((r.length - t) * l + 1) >>> 0,
            c = new Uint8Array(f);
          while (r[t]) {
            var h = e[r.charCodeAt(t)];
            if (255 === h) return;
            for (var w = 0, s = f - 1; (0 !== h || w < a) && -1 !== s; s--, w++)
              (h += (i * c[s]) >>> 0),
                (c[s] = h % 256 >>> 0),
                (h = (h / 256) >>> 0);
        ...
        return { encode: h, decodeUnsafe: w, decode: s };
      }
      r.exports = o;
    },
    7191: function (r, e, t) {
